...
MODEL_PATH = "D:/Users/matvey/Documents/UnrealProjects/Deep2DRunner/saved_networks"  # path to saved models
...
LOG_PATH = "D:/Users/matvey/Documents/UnrealProjects/Deep2DRunner/logs"  # path to logs
...
class AgentTrainer(object):
    ...
    def process_frame(self, screen, reward, terminal):
        ...
        if self.t % LOG_PERIOD == 0:
            ...
            ue.log("TIMESTEP {}, STATE {}, EPSILON {}, ACTION {}, REWARD {}".format(
                    self.t,
                    state,
                    self.epsilon,
...
#     def update(self, is_dead, new_score):

#         if is_dead:
#             reward = -1
# #        elif new_score - self.score > 1:
# #            reward = 2
...
#         ue.log("UPD: {}, {}, {}".format(is_dead, new_score, reward))
#         return reward
...
class PythonAIController(object):
    ...
    def tick(self, delta_seconds: float):
        ...
        pawn.py_jump = True if action == 1 else False
